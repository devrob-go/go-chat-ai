...
func InitDB(ctx context.Context, appCfg *configs.Config, logger *zlog.Logger) (*DB, error) {
...
func FromConfig(appCfg *configs.Config) *Config {
	return &Config{
		ConnStr: fmt.Sprintf(
		...
		MigrationsDir:   appCfg.MigrationsDir,
